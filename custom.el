...
")
 ...
 '(package-selected-packages
   (quote
    (binclock thinks uptimes w3m slime sass-mode restclient powershell markdown-mode hyde highlight-chars emojify dictionary csharp-mode browse-kill-ring boxquote auto-compile)))
